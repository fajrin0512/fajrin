 ...
 * @author Lenovo
 */
public class APpDuaAngka extends javax.swing.JFrame {

    /**
     * Creates new form APpDuaAngka
     */
    public APpDuaAngka() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(APpDuaAngka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new APpDuaAngka().setVisible(true);
            }
        });
    }
